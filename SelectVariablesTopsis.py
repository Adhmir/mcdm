...
def novajanela(root, df):
    ...
    SVariable.title("Selecionar variáveis TOPSIS")
    ...
    btnMadr = Button(SVariable, text="Método TOPSIS", 
                        fg = 'black', bg = 'White', font = 'time 8 bold',
    ...
    def janelaAdr():
        ...
        #print(lista_var)
        tvtopsis.novajanela(SVariable, pesos, lista_var, lstid, lstctg,  df)          
