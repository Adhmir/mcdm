# -*- coding: utf-8 -*-
"""
Created on Sat Jan 29 10:13:12 2022

@author: Adhmir Renan Voltolini Gomes
Seleciona as variáveis para calcular a ENTROPIA
"""

#import tkinter as tk
from tkinter import Label, Button, Listbox, Toplevel, ANCHOR, END, LabelFrame
from tkinter import ttk, Scrollbar
import TreeviewEntropia as tvtEntropia
...
def novajanela(root, df):
    ...
    SVariable.title("Selecionar variáveis ENTROPIA")
    ...
    btnMadr = Button(SVariable, text="Método ENTROPIA", 
                        fg = 'black', bg = 'White', font = 'time 8 bold',
    ...
    def janelaAdr():
        ...
        #print(lista_var)
        tvtEntropia.novajanela(SVariable, pesos, lista_var, lstid, lstctg,  df)          
