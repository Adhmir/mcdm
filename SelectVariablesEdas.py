# -*- coding: utf-8 -*-
"""
Created on Thu Dec 30 10:19:41 2021
...
def novajanela(root, df):
    ...
    SVariable.title("Selecionar variáveis EDAS")
    ...
    btnMadr = Button(SVariable, text="Método EDAS", 
                        fg = 'black', bg = 'White', font = 'time 8 bold',
    ...
    def janelaAdr():
        ...
        #print(lista_var)
        tvedas.novajanela(SVariable, pesos, lista_var, lstid, lstctg,  df)          
