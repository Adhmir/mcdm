# -*- coding: utf-8 -*-
"""
Created on Thu Dec 30 12:16:14 2021
...
def novajanela(root, df):
    ...
    SVariable.title("Selecionar variáveis DP2")
    ...
    btnMadr = Button(SVariable, text="Método DP2", 
                        fg = 'black', bg = 'White', font = 'time 8 bold',
    ...
    def janelaAdr():
        ...
        #print(lista_var)
        tvdp2.novajanela(SVariable, lista_var, lstid, lstctg,  df)
