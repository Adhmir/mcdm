# -*- coding: utf-8 -*-
"""
Created on Sat Jan 29 10:18:28 2022

@author: Adhmir Renan Voltolini Gomes
""" 


import algoritmo_entropia as algentropia
import pandas as pd
from tkinter import Toplevel, Scrollbar, ttk, LabelFrame, Button
from tkinter import filedialog
 

def novajanela(SelectVariables, pesos, lista_var, lstid, lstctg, df1):
    ...
    def calcular(df, pesos):
        #global Metodo_salvar
        #Metodo_salvar = ["calcular"]
        df = algentropia.FuncaoEntropia(df, pesos)
        return df
    
    
    def buildDf(df, lista_var, lstid, lstctg, pesos):
        ...
        if lstid != emp and lstctg != emp:
            ...
            print('normal')
            result = calcular(dfv, w)                      
            
        return result
    
    
    df = buildDf(df1, lista_var, lstid, lstctg, pesos)
